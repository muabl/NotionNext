...
const BLOG = {
  AUTHOR: 'loli', // 作者
  BIO: '爱萝莉🍚', // 作者简介
  LINK: 'https://www.lolicy.eu.org', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '8009846fe4b746fcabf94096dcfdfa7c', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'mail@lolicy.eu.org',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: '',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_VALINE_APP_ID: process.env.NEXT_PUBLIC_VALINE_ID || 'VOFDCBINPrM6Ea4yGYrh1Pvg-gzGzoHsz', // Valine @see https://valine.js.org/quickstart.html 或 https://github.com/stonehank/react-valine#%E8%8E%B7%E5%8F%96app-id-%E5%92%8C-app-key
  COMMENT_VALINE_APP_KEY: process.env.NEXT_PUBLIC_VALINE_KEY || 'XsYrVREnl1V26UNLEbk0ZqXx',
